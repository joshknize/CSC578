...
chosen_class_ids = [18]  # dog

annotations_path = '../datasets/coco/annotations/filtered_instances_val2017_2.json'
...
filtered_annotations_path = '../datasets/coco/annotations/dog_instances_val2017.json'
